...
RESOURCES += src/qt/dotme.qrc src/qt/dotme_locale.qrc

TRANSLATIONS += src/qt/locale/dotme_bg.ts \
                src/qt/locale/dotme_de.ts \
                src/qt/locale/dotme_en.ts \
                src/qt/locale/dotme_es.ts \
                src/qt/locale/dotme_fi.ts \
                src/qt/locale/dotme_fr.ts \
                src/qt/locale/dotme_it.ts \
                src/qt/locale/dotme_ja.ts \
                src/qt/locale/dotme_pl.ts \
                src/qt/locale/dotme_pt.ts \
                src/qt/locale/dotme_ru.ts \
                src/qt/locale/dotme_sk.ts \
                src/qt/locale/dotme_sv.ts \
                src/qt/locale/dotme_vi.ts \
                src/qt/locale/dotme_zh_CN.ts \
                src/qt/locale/dotme_zh_TW.ts
