...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DotMe features */
        {"dotme", "masternode", &masternode, true, true, false},
        {"dotme", "masternodelist", &masternodelist, true, true, false},
        {"dotme", "mnbudget", &mnbudget, true, true, false},
        {"dotme", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"dotme", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"dotme", "mnsync", &mnsync, true, true, false},
        {"dotme", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"dotme", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use dotmed, or the -server option to dotme-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> dotme-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:18320/\n";
}
