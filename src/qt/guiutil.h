...
/** Utility functions used by the DotMe Qt UI.
 */
namespace GUIUtil
{
...
// Render DotMe addresses in monospace font
...
// Parse "dotme:" URI into recipient object, return true on successful parsing
