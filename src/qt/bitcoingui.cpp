                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DotMe Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DotMe address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dotme: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DotMe Core"), this);
    aboutAction->setStatusTip(tr("Show information about DotMe Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DotMe"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DotMe addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DotMe addresses"));
    ...
    openAction->setStatusTip(tr("Open a DotMe: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DotMe Core help message to get a list with possible DotMe command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DotMe Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DotMe network", "", count));
}
...
{
    QString strTitle = tr("DotMe Core"); // default title
