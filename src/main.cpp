...
#if defined(NDEBUG)
#error "DotMe cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    } else if (nHeight >= 1 && nHeight < 345600) {
        nSubsidy = 30 * COIN;
    } else if (nHeight >= 345600 && nHeight < 691200) {
        nSubsidy = 20 * COIN;
    } else if (nHeight >= 691200 && nHeight < 1000000) {
        nSubsidy = 10 * COIN;
