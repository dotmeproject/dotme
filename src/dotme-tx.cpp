...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("DotMe Core dotme-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  dotme-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dotme transaction") + "\n" +
                               "  dotme-tx [options] -create [commands]   " + _("Create hex-encoded dotme transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dotme transaction
