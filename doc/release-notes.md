DotMe Core version 2.2.1 is now available from:

  <https://github.com/dotmeproject/dotme/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/dotmeproject/dotme/issues>

Compatibility
==============

DotMe Core is extensively tested on multiple operating systems using
...
DotMe Core should also work on most other Unix-like systems but is not
...
of Bitcoin that DotMe was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/dotme-project-translations/).
