...
In order to support loading of multiple wallets in dotme-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dotme.cpp.
...
Changes to dotme.cpp
----------------------
dotme.cpp is the entry point into dotme-qt, and as such, will require some minor modifications to provide hooks for
