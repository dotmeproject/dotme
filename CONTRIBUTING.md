Contributing to DotMe Core
============================

The DotMe Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DotMe Core project, and is not to be
confused with overall DotMe Network Protocol consensus changes.

Whether a pull request is merged into DotMe Core rests with the project merge
...
Patches that change DotMe consensus rules are considerably more involved than
...
Where a patch set proposes to change the DotMe consensus, it must have been
...
The project leader is the release manager for each DotMe Core release.
